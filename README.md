...
1- Code
      ...
      learn.org/stable/modules/generated/sklearn.ensemble.StackingRegressor.html).    2.Predicted_MMM_CO2_code.py that has the code for a human-computer interactive interface software.
